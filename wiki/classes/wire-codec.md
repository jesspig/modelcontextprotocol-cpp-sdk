...
2026 时代入站收到 ping、tasks/*、elicitation/create 等不在时代的方法：`ValidateRequest` 判定为 `NotInEra`，McpSessionHandler 回 `-32601 MethodNotFound`（initialize 豁免，[McpSessionHandler.cpp:229](../../src/protocol/McpSessionHandler.cpp)）。
