...
inline constexpr char kStatus[] = "status";inline constexpr char kRequestId[] = "requestId";inline constexpr char kContents[] = "contents";inline constexpr char kElicit[] = "elicit";
inline constexpr char kSupportedVersions[] = "supportedVersions";
inline constexpr char kResourceTemplates[] = "resourceTemplates";inline constexpr char kSrc[] = "src";
inline constexpr char kVersion[] = "version";
inline constexpr char kWebsiteUrl[] = "websiteUrl";inline constexpr char kForm[] = "form";
inline constexpr char kUrl[] = "url";inline constexpr char kProgress[] = "progress";inline constexpr char kSizes[] = "sizes";
inline constexpr char kTheme[] = "theme";inline constexpr char kRequiredCapabilities[] = "requiredCapabilities";
